...
export default function JobPostingNewPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    setLoading(true);
    try {
      const result = await api.createJobPosting({
        title,
      ...
      <main className="max-w-lg mx-auto px-4 py-12">
        <div className="bg-white shadow-sm border border-gray-200 rounded-xl p-6">
          <div className="space-y-1 mb-6">
            <h2 className="text-lg font-semibold text-gray-900">Créer une offre</h2>
            <p className="text-sm text-gray-500">Remplissez les informations de l&apos;offre d&apos;emploi</p>
          </div>
